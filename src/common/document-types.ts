...
import { PrimitiveTypes } from './common-types';
import { FormListSettings } from './user.settings';
...
export interface Relation { name: string; type: string; field: string; }
export interface CopyTo { type: string; label: string; Operation?: Ref; icon: string; order: number; }
